       ...
       -->
		...
		<el-table :data="datalist" highlight-current-row v-loading="listLoading" style="width: 100%;">
            ...
            <el-table-column label="操作" min-width="160">
                ...
                <el-button size="small" type="primary"  @click="update(scope.$index,scope.row)">绑定代理商</el-button>
        ...
        <el-dialog   :title="formtitle" :visible.sync="dialogFormVisible" >
			<el-form ref="subData" :model="subData" label-width="100px" @submit.prevent="onSubmit" style="margin:20px;"  id="formid" action=""  method="post" enctype="multipart/form-data" target="frameName">
                    ...
                    <el-form-item label="展示代理商">
                     
                        <el-select  v-model="subData.agentUserId"  @change="selectModel($event)" placeholder="请选择代理商">
                             <el-option
...
<script>
    ...
    handleRemove(file, fileList) {
      ...
      update(index, rows) {
        ...
        this.show = "2";
        this.subData =  rows;  
        RequestGet("/user/findAll2",{parentId:"66b7ef552d9e4e4599e853c7d6101373"}).then(response => {
						if(response.code == '0000'){
      ...
      selectModel(id){
            ...
            this.subData.agentUserName = obj.userName;
      ...
      open(){
       ...
       // this.validate();
       if(this.subData.agentUserId=="" || this.subData.agentUserId == null){
            this.$message({
                type: 'error',
                message: '代理商不能为空'
            });         
